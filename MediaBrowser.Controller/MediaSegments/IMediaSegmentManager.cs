...
public interface IMediaSegmentManager
{
    ...
    /// <param name="forceOverwrite">If set, will force to remove existing segments and replace it with new ones otherwise will check for existing segments that should not be deleted and if found any, stops.</param>
